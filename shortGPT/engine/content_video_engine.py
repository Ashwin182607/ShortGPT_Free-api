...
from shortGPT.api_utils.video_source_manager import VideoSourceManager
    ...
    def _generateVideoUrls(self):
        ...
        for (t1, t2), search_terms in timed_video_searches:
            ...
            for query in reversed(search_terms):
                url = VideoSourceManager.get_best_video(query, orientation_landscape=not self._db_format_vertical, used_vids=used_links)
                if url:
